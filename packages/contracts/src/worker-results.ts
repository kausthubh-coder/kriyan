...
export const workerJobResultSchema = s.object({
  ...
  requiredCapabilities: s.optional(s.array(string)), preferredNodeId: optionalString,
...
export const WORKER_OPERATION_RESULT_SCHEMAS: {
  ...
  'memory.correction.create': s.object({ created: boolean, correction: workerCorrectionResultSchema }),
